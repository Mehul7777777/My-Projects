...
Button(root, text="+", command=lambda :get_operation("+")).grid(row=2, column=3, sticky=N+E+W+S)
Button(root, text="-", command=lambda :get_operation("-")).grid(row=3, column=3, sticky=N+E+W+S)
Button(root, text="*", command=lambda :get_operation("*")).grid(row=4, column=3, sticky=N+E+W+S)
Button(root, text="/", command=lambda :get_operation("/")).grid(row=5, column=3, sticky=N+E+W+S)

# adding new operations
Button(root, text="pi", command=lambda :get_operation("*3.14")).grid(row=2, column=4, sticky=N+E+W+S)
Button(root, text="-", command=lambda :get_operation("%")).grid(row=3, column=4, sticky=N+E+W+S)
Button(root, text="(", command=lambda :get_operation("(")).grid(row=4, column=4, sticky=N+E+W+S)
Button(root, text="**", command=lambda :get_operation("**")).grid(row=5, column=4, sticky=N+E+W+S)

Button(root, text="<-", command=lambda :undo()).grid(row=2, column=5, sticky=N+E+W+S)
Button(root, text="x!", command=lambda :fact()).grid(row=3, column=5, sticky=N+E+W+S)
Button(root, text=")", command=lambda :get_operation(")")).grid(row=4, column=5, sticky=N+E+W+S)
Button(root, text="^2", command=lambda :get_operation("**2")).grid(row=5, column=5, sticky=N+E+W+S)
Button(root, text="^2", command=lambda :get_operation("**2")).grid(row=5, column=5, sticky=N+E+W+S)
Button(root, text="=", command=lambda :calculate()).grid(row=6, column=5, sticky=N+E+W+S)
